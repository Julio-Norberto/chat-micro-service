...
import (
	...
	"github.com/Julio-Norberto/chat-micro-service/internal/domain/gateway"
...
type ChatCompletionUseCase struct {
	ChatGateway  gateway.ChatGateway // save the messages in DB
	OpenAiClient *openai.Client      // call the api
...
func createNewChat(input ChatCompletionInputDTO) (*entity.Chat, error) {
	...
	if err != nil {
		return nil, errors.New("error creating inital message: " + err.Error())
	}
